...
bisa berubah, verifikasi ulang sebelum dipakai.

Pemilihan broker sengaja di luar cakupan dokumen ini dan di luar sistem:
screener berhenti di daftar kandidat dan zona harga, eksekusinya manual.
...
| | IDX | AS |
|---|---|---|
| Satuan | Lot 100 lembar | Per lembar; **fraksional** umum tersedia (bisa beli 0,1 lembar) |
...
| Hal | Aturan |
|---|---|
| Dividen | AS memotong *withholding tax* **30%**; turun menjadi tarif P3B Indonesia–AS (umumnya **15%**) bila formulir **W-8BEN** sudah diisi di akun. Isi W-8BEN **sebelum** dividen pertama; berlaku 3 tahun |
...
## 5. Istilah yang sering tertukar
